...
Welcome to Sketchware Bro! Here you'll find the source code of many classes in Sketchware Bro and, most importantly, the place to contribute to Sketchware Bro.
...
If you'd like to contribute to Sketchware Bro, follow these steps:
...
Thank you for contributing to Sketchware Bro! Your contributions help keep Sketchware Bro alive. Each accepted contribution will be noted down in the "About Team" activity. We'll use your GitHub name and profile picture initially, but they can be changed, of course.
...
We do NOT permit publishing Sketchware Bro as it is, or with modifications, on Play Store or on any other app store. Keep in mind that this project is still a mod. Unauthorized modding of apps is considered illegal and we discourage such behavior.
